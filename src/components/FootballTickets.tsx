                        ...
                        <div className="py-4 pb-4">
                            ...
                            <div className="py-2">
                                <p>
                                    ...
                                    of the football stadiums and follow these steps:
                                </p>
                            </div>
                            <div className="py-2">
                                <ul className="list-disc pl-5 space-y-2">
                                    <li>Select the match you want to attend</li>
                                    <li>Select the tickets you want to book</li>
                                    <li>Enter the number of tickets you need and click on buy</li>
                                    <li>Fill in your details and click "make payment"</li>
                                </ul>
                            </div>
...
export default FootballTickets;
