...
const Header = ({ isScrolledPastHero, fixed }: { isScrolledPastHero: boolean, fixed: boolean }) => {
  ...
  return (
    <header className={`w-full top-0 left-0 z-50 bg-white shadow-md ${fixed ? "fixed" : ""
      }`}>
      {/* Top Info Bar */}
      <div className="w-full bg-white text-gray-700 py-2 text-sm border-b">
        <div className="ticket-container">
          <p className="text-center">
            We're the most trusted secondary marketplace for football tickets.
        ...
        <div className="ticket-container flex justify-between items-center">
          <Link to="/" className="flex items-center">
            <div>
              <span className="font-bold text-2xl">
                live<span className="text-ticket-red">football</span>tickets
              </span>
          ...
          <div className="flex items-center gap-1">
            ...
            >
              ...
              <PopoverContent className="w-100 p-6" align="end">
                <div className="bg-ltg-white relative grid p-4 pb-10">
            ...
            >
              ...
              <PopoverContent className="w-100 p-0" align="end">
                <div className="bg-ltg-white relative grid p-6 pb-10">
                  <h3 className="font-dosis border-b-ltg-grey-4 border-b pb-4 text-l font-medium">
            ...
            <div className="flex">
              ...
              <div className="group relative">
                ...
                <div className="bg-ltg-white border-b-ltg-grey-4 shadow-ltg-grey-2 absolute z-10 hidden space-y-2 rounded-b-md px-4 py-2 shadow-lg group-hover:block bg-white min-w-[200px]">
                  ...
                  <a href="/matches?team=Liverpool&league=Premier League" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">Liverpool</a>

                  <a href="/matches?team=Chelsea&league=Premier League" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">Chelsea</a>


                  <a href="/matches?team=Manchester United&league=Premier League" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">Manchester United</a>


                  <a href="/matches?team=Arsenal&league=Premier League" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">Arsenal</a>


                  <a href="/league?league=Premier League" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">View All</a>
              ...
              <div className="group relative">
                ...
                <div className="bg-ltg-white border-b-ltg-grey-4 shadow-ltg-grey-2 absolute z-10 hidden space-y-2 rounded-b-md px-4 py-2 shadow-lg group-hover:block bg-white min-w-[200px]">
                  ...
                  <a href="/competition/fa-cup.html" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">FA Cup</a>

                  <a href="/competition/efl-cup.html" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">EFL Cup</a>

                  <a href="/competition/community-sheild.html" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">Community Sheild</a>

                  <a href="/competition/championship-play-off-final.html" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">Championship Play Off Final</a>
              ...
              <div className="group relative">
                ...
                <div className="bg-ltg-white border-b-ltg-grey-4 shadow-ltg-grey-2 absolute z-10 hidden space-y-2 rounded-b-md px-4 py-2 shadow-lg group-hover:block bg-white min-w-[200px]">
                  ...
                  <a href="/competition/champions-league.html" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">Champions League</a>

                  <a href="/competition/europa-league.html" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">Europa League</a>

                  <a href="/competition/super-cup.html" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">Super Cup</a>

                  <a href="/competition/conference-league.html" className="border-b-ltg-grey-4 block min-w-[250px] border-b-2 py-3 text-left text-base text-black last:border-b-0 hover:text-opacity-50">Conference League</a>
